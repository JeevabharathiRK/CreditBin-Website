...
header .navbar { max-width: 1280px;
margin: 0 auto;
display: flex;
align-items: center;
...
.menu-links{ background-color:#1B1B1D;
color: #fff;
padding: 10px 20px;
border: none;
border-radius: 5px;
...
.navbar 
.menu-links li a:hover { color: #1dbf73;
}
...
.navbar #hamburger-btn { color: #fff;
cursor: pointer;
display: none;
font-size: 1.7rem;
}
...
.navbar #close-menu-btn { position: absolute;
display: none;
color:black;
top: 20px;
right: 20px;
...
@media screen and (max-width: 900px) {
  header.show-mobile-menu::before { content: ""; 
height: 100%;
width: 100%;
position: fixed;
left: 0;
